...
export const getDataManager = params => { return axios.get(host + 'http://172.19.32.116/fluxdata/origindata/show', {'params': params}) }
export const getIndexData = params => { return axios.get(host + 'http://172.19.32.116/fluxdata/origindata/show', {'params': params}) }
